...
class Pin {
	...
	private function emailTemplate(
		...
		<small>If you don't want to receive these email notifications, please update your email notification preference in your <a href='".site_url('account/email')."'>Email Settings</a> page.</small>
