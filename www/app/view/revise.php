			...
			<div class="wrap xl-gutter-8">
				<div class="col dropdown info">
					...
					<ul class="center xl-left">
						...
						<li><a href="<?=site_url('revise/'.$device_ID.'?redownload&ssr')?>" class="bottom-tooltip center-tooltip" data-tooltip="Coming soon: If you want to revise a JS-created webpage, you can revise your page after the JS outputs the content. !!!"><i class="fa fa-bolt"></i> SERVER SIDE RENDERING</a></li>
					</ul>
