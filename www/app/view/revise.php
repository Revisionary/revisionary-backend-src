		...
		<div class="col xl-left pin-mode">
			...
			<div class="dropdown current-mode" data-pin-type="<?=$pin_mode?>" data-pin-private="<?=$pin_private?>">
				...
				<ul class="pin-types">
					...
					<li class="bottom-tooltip <?=$pin_mode == "comment" && $pin_private == "0" ? "selected" : ""?>" data-pin-type="comment" data-pin-private="0" data-tooltip="In development..." style="display: none !important;"><a href="#"><i class="fa fa-comment"></i> ONLY COMMENT MODE</a></li>
