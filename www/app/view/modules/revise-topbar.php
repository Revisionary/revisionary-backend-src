			...
			<div class="wrap xl-gutter-8">
				<div class="col dropdown info">
					...
					<ul class="center xl-left" style="max-width: 300px;">
						...
						<li><a href="<?=site_url('revise/'.$device_ID.'?redownload&capture')?>" class="bottom-tooltip center-tooltip" data-tooltip="Revisionary takes your page's full size screenshot and you can only put comment pins on it. This should only be used if the page doesn't show up correctly."><i class="fa fa-file-image"></i> SITE CAPTURE MODE</a></li>
