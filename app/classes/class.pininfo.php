...
class Pin {
	...
	public function comments() {
		...
		$db->where('pin_ID', self::$pin_ID);
		$comments = $db->connection('slave')->get('pin_comments c', null, "c.comment_ID, c.comment_modified, c.pin_comment, c.comment_type, c.comment_added, c.comment_modified, u.user_first_name, u.user_ID, u.user_last_name, u.user_picture, u.user_email");
	...
	public function newNotification(
		...
		// Web notification
		Notify::ID($users)->web("new", "pin", self::$pin_ID, $pin_number, $this->project_ID, $this->page_ID, $this->phase_ID, $this->device_ID, self::$pin_ID);
	...
	public function completeNotification(
		...
		// Web notification
		Notify::ID($users)->web("complete", "pin", self::$pin_ID, $pin_number, $this->project_ID, $this->page_ID, $this->phase_ID, $this->device_ID, self::$pin_ID);
	...
	public function inCompleteNotification(
		...
		// Web notification
		Notify::ID($users)->web("incomplete", "pin", self::$pin_ID, $pin_number, $this->project_ID, $this->page_ID, $this->phase_ID, $this->device_ID, self::$pin_ID);
